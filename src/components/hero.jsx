const Hero = () => {
    return (
        <>
            <div
                className="max-w-full h-screen bg-gradient-to-tl from-[#5CC1AD] via-[#5cc1ad84] to-white text-start curved-bottom"
                id="/"
            >
                <div className="w-full h-full flex flex-col md:flex-row-reverse items-center max-w-7xl mx-auto px-5  md:px-8 -mt-2  lg:-mt-20">
                    <div
                        data-aos="fade-left"
                        className="w-full flex justify-center md:w-1/2 h-1/2"
                    >
                        <img
                            src={"/assets/hero.svg"}
                            alt=""
                    ...
                    <div className="w-full md:w-1/2">
                        ...
                        <p
                            data-aos="fade-up"
                            className="text-gray-600 mb-8 text-sm md:text-lg lg:text-2xl"
                        >
                            Create content 12x faster with our artificial
                            intelligence. Jiandikie helps you to create
                            high-quality content, in just a few seconds.
                        </p>
                        <button
                            data-aos="fade-up"
